...
HasteDependencyResolver.prototype.getDependencies = function(
  main,
  options,
) {
  ...
  return this._depGraph
    .getDependencies(main, opts.platform)
    .then(resolutionResponse => {
      this._getPolyfillDependencies(opts.dev)
        .reverse()
        .forEach(polyfill =>
...
HasteDependencyResolver.prototype._getPolyfillDependencies = function(
  isDev,
) {
...
HasteDependencyResolver.prototype.wrapModule = function(
  resolutionResponse,
  module,
  code,
) {
