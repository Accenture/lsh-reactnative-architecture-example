...
(function(global) {
  ...
  var _now = _performance
    ? _performance.now.bind(_performance)
    : function() {
        return 0;
      };
  ...
  function define(
    ...
    if (__DEV__) {
      ...
      if (toString.call(dependencies) !== '[object Array]') {
        throw new ModuleError(
          'Invalid dependencies for module "' +
            id +
            '". ' +
  ...
  global.__d = function(id, deps, factory, _special, _inlineRequires) {
    ...
    define(id, defaultDeps.concat(deps), factory, _special ||
      USED_AS_TRANSPORT, null, null, _inlineRequires);
  };
})(this);
