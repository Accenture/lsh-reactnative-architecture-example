...
var ReactNativeMount = {
  ...
  renderComponent: function(
    ...
    var topRootNodeID =
      ReactNativeTagHandles.tagToRootNodeID[containerTag];
    if (topRootNodeID) {
      var prevComponent =
        ReactNativeMount._instancesByContainerID[topRootNodeID];
      if (prevComponent) {
    ...
    var topRootNodeID = ReactNativeTagHandles.allocateRootNodeIDForTag(
      containerTag,
    );
