...
var TextInput = React.createClass({
  propTypes: {
     ...
     * @platform android
     */
    textAlignVertical: PropTypes.oneOf(['top', 'center', 'bottom']),
    /**
  ...
  _renderAndroid: function() {
    var autoCapitalize =
      RCTUIManager.UIText.AutocapitalizationType[
        this.props.autoCapitalize
      ];
    var textAlign =
      RCTUIManager.AndroidTextInput.Constants.TextAlign[
        this.props.textAlign
      ];
    var textAlignVertical =
      RCTUIManager.AndroidTextInput.Constants.TextAlignVertical[
