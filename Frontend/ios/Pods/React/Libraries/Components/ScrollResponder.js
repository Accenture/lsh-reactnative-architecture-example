...
var ScrollResponderMixin = {
  ...
  scrollResponderHandleStartShouldSetResponderCapture: function(
    ...
    if (
      this.props.keyboardShouldPersistTaps === false &&
  ...
  scrollResponderScrollTo: function(offsetX: number, offsetY: number) {
    if (Platform.OS === 'android') {
      ...
      RCTUIManager.scrollTo(React.findNodeHandle(this), offsetX, offsetY);
    }
  },
  ...
  scrollResponderInputMeasureAndScrollToKeyboard: function(
    ...
    if (this.keyboardWillOpenTo) {
      var scrollOffsetY =
        top -
        this.keyboardWillOpenTo.endCoordinates.screenY +
        height +
  ...
  componentWillMount: function() {
    ...
    warning(
      ...
      'You need to implement getInnerViewNode in ' +
