...
class XMLHttpRequest extends XMLHttpRequestBase {
  ...
  _didCreateRequest(requestId: number): void {
    ...
    this._subscriptions.push(
      RCTDeviceEventEmitter.addListener('didSendNetworkData', args =>
        this._didUploadProgress.call(this, args[0], args[1], args[2]),
      ),
    );
    this._subscriptions.push(
      RCTDeviceEventEmitter.addListener(
        ...
        args =>
          this._didReceiveResponse.call(this, args[0], args[1], args[2]),
      ),
    );
    this._subscriptions.push(
      RCTDeviceEventEmitter.addListener('didReceiveNetworkData', args =>
        this._didReceiveData.call(this, args[0], args[1]),
      ),
    );
    this._subscriptions.push(
      RCTDeviceEventEmitter.addListener(
