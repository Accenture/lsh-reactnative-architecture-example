...
describe('diffRawProperties', function() {
  ...
  it('should remove fields', () => {
    expect(diffRawProperties(null, { a: 1 }, {}, { a: true })).toEqual({
      a: null,
    });
  });

  it('should ignore invalid fields', () => {
    expect(diffRawProperties(null, { a: 1 }, { b: 2 }, {})).toEqual(null);
  });
  ...
  it('should work with undefined styles', () => {
    expect(
      diffRawProperties(null, { a: 1, c: 3 }, undefined, {
        a: true,
        b: true,
      }),
    ).toEqual({ a: null });
    ...
    expect(
      diffRawProperties(null, undefined, undefined, { a: true, b: true }),
    ).toEqual(null);
  });

  it('should work with empty styles', () => {
    expect(
      diffRawProperties(null, { a: 1, c: 3 }, {}, { a: true, b: true }),
    ).toEqual({ a: null });
    expect(
      diffRawProperties(null, {}, { a: 1, c: 3 }, { a: true, b: true }),
    ).toEqual({ a: 1 });
    expect(diffRawProperties(null, {}, {}, { a: true, b: true })).toEqual(
      null,
    );
  });
